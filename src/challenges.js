...
function howManyTimes(repWord, word2search) {

let acount = 0

repWord.forEach(function(repeated){
  if (repeated === word2search){
    acount++;
  }
})
return acount;
...
function filterOut(arrstring, arrfilterout) {
